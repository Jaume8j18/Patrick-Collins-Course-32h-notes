...
async function main() {
  ...
  const wallet = new ethers.Wallet(
    "0x5668cf465651b1221d7c9951fbffe09b94271ab0ac7b724b38608b5815284a27",
    provider
  );
  ...
  //transaction receipt is what u get when u wait for a transaction to finish
  //transaction response is what you get when yopu create your transaction
  ...
  //   //por el hecho de llamar a la funcion sendtransaction esta de por si ya hace el sign (ver con ctrl click)
  //   await sentTxResponse.wait(1);
  //   //wait(1) is waiting for 1 block confirmation for the transaction goes true
...
//AHORA VAMOS A QUITAR LAS PRIVATE KEYS DEL CODIGO PARA HACERLO MAS SEGURO DEJO EL CÓDIGO COMPLETO DE JUSTO ANTES
...
async function main() {
  ...
  const wallet = new ethers.Wallet(
    "0x563914bfd3ca93dba54c6f409896bde5b48e4d296a4f05eaa6983cf085268caa",
    provider
  );
  const abi = fs.readFileSync("./SimpleStorage_sol_SimpleStorage.abi", "utf-8");
  const binary = fs.readFileSync(
